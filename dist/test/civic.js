...
var SECRET = '7cf5ac70fc9eb1671c85547ef594599ce8214e0c6563e12f24cbd338b8e649c4';
var HEX_PUBKEY = '04ac75e5f6d7b161b8337e13d467f0b7a1692931b7e6dd64dd63686d203455a603a23708044ae5edab04f98601a08478cf603c699a75ee9f34e974b166df9fae34';

// secp256r1 ECC curve for key pair:
var SECRET_NIST = 'a3ed0dd27cbfa62e13e340fb3dbb86895b99d5fd330a80e799baffcb1d29c17a';
...
describe('jwt-js Token module', function () {
  ...
  it('should generate JWT token using ES256K Algorithm', function (done) {
    ...
    var signer = new jwtjs.TokenSigner(ALGO, SECRET);

    tokenES256 = signer.sign(payload);
    console.log('tokenES256 = ', tokenES256);

    var verifier = new jwtjs.TokenVerifier(ALGO, HEX_PUBKEY);
    var result = verifier.verify(tokenES256);
