...
/*
 * Note: The original sourcecode autogenerated by the Amazon APIGateway has been modified by
 * Civic.
 */

var utils = require("./utils");
var CryptoJS = require("../CryptoJS/rollups/hmac-sha256");
...
sigV4ClientFactory.newClient = function (config) {
    ...
    awsSigV4Client.host = utils.assertDefined(config.host, 'host');
